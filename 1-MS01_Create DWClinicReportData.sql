/***************************************************************************
ETL Final Project: DWClinicReportData RRoot
Dev: RRoot
...
ChangeLog: (Who, When, What) 
  ...
  <YourNameHere>, <TheDate>, modified the database name for ETL development project
*****************************************************************************************/
Use Master;
go

If Exists (Select * From Sys.databases where Name = 'DWClinicReportDataRRoot')
  Begin
   Alter Database DWClinicReportDataRRoot set single_user with rollback immediate;
   Drop Database DWClinicReportDataRRoot;
  End
go

Create Database DWClinicReportDataRRoot;
go

Use DWClinicReportDataRRoot;
go
...
,DoctorState nvarchar(100) Not Null -- Would be better if this were 2 chars
...
,PatientState varchar(100) Not Null -- Would be better if this were 2 chars
