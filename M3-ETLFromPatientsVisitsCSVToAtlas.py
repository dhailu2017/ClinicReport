...
strFilePath = "..\\DataFiles\\DoctorsSchedule.csv"
strCon = "mongodb+srv://BICert:BICert@cluster0-omzbi.azure.mongodb.net/FinalDB?retryWrites=true&w=majority"

objCon = pymongo.MongoClient(strCon)
db = objCon["FinalDB"]  # Creates or Connects a database
